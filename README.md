...
#### **Backward induction** 
   ...
   In the trust game, we can assume that the other player will choose their optimal strategy at each stage. The process is as follows: 
    - At the final stage of the game, if the investor has chosen to invest and the Player B has chosen to return the investment plus an additional amount, both players receive a positive payoff. Therefore, it is the best interest of both players to choose these strategies at the final stage. 
